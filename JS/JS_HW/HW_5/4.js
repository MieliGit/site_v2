...
const productPhoto = productsSecond.filter(productsSecond => productsSecond.photos && productsSecond.photos.length > 0);
console.log(productPhoto)

const productSort =[...productsSecond].sort((a, b) => a.price - b.price);
